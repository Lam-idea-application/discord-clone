...
import { Axis3D, CandlestickChart, Edit, FileIcon, ShieldCheck, Trash } from "lucide-react";
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            disabled={isLoading}
                            className="dark:bg-zinc-700/75 border-none border-0 focus-visible:right-0 text-zinc-600 dark:text-zinc-200"
